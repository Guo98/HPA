...
BPHybrid::~BPHybrid()
{
    int firstCompletion = 0;
    int secondCompletion = 0;
    int thirdCompletion = 0;
    int fourthCompletion = 0;
    double firstDenom = 0;
    double secondDenom = 0;
    double thirdDenom = 0;
    double fourthDenom = 0;
    double firstNumer = 0;
    double secondNumer = 0;
    double thirdNumer = 0;
    double fourthNumer = 0;
  
    for(int i = 0; i < 3000; i++) {
	if(instInfo[i] != 0) {
		if(0 < totalPreds[i] && totalPreds[i] < 20) {
			firstCompletion++;	
			firstNumer += correctPreds[i];
			firstDenom += totalPreds[i];
		} else if(19 < totalPreds[i] && totalPreds[i] < 200) {
			secondCompletion++;
			secondNumer += correctPreds[i];
			secondDenom += totalPreds[i];
		} else if(199 < totalPreds[i] && totalPreds[i] < 2000) {
			thirdCompletion++;
			thirdNumer += correctPreds[i];
			thirdDenom += totalPreds[i];
		} else if(1999 < totalPreds[i]) {
			fourthCompletion++;
			fourthNumer += correctPreds[i];
			fourthDenom += totalPreds[i];
		}
	}
    }

    std::cout << "Hybrid 1-19 Number of Branches: " << firstCompletion << " With accuracy: " << firstNumer/firstDenom << "\n";
    std::cout << "Hybrid 20-199 Number of Branches: " << secondCompletion << " With accuracy: " << secondNumer/secondDenom << "\n";
    std::cout << "Hybrid 200-1999 Number of Branches: " << thirdCompletion << " With accuracy: " << thirdNumer/thirdDenom << "\n";
    std::cout << "Hybrid 2000+ Number of Branches: " << fourthCompletion << " With accuracy: " << fourthNumer/fourthDenom << "\n";
    std::cout << "Hybrid Overall accuracy: " << (firstNumer + secondNumer + thirdNumer + fourthNumer)/(firstDenom + secondDenom + thirdDenom + fourthDenom) << "\n";
}
...
BPredictor::~BPredictor()
{
    ...
    std::cout << "1-19 Number of Branches: " << firstCompletion << " With accuracy: " << firstNumer/firstDenom << "\n";
    std::cout << "20-199 Number of Branches: " << secondCompletion << " With accuracy: " << secondNumer/secondDenom << "\n";
    std::cout << "200-1999 Number of Branches: " << thirdCompletion << " With accuracy: " << thirdNumer/thirdDenom << "\n";
    std::cout << "2000+ Number of Branches: " << fourthCompletion << " With accuracy: " << fourthNumer/fourthDenom << "\n";
    std::cout << "Overall accuracy: " << (firstNumer + secondNumer + thirdNumer + fourthNumer)/(firstDenom + secondDenom + thirdDenom + fourthDenom) << "\n";
    dump(section);
